...
function Questoes() {
  ...
  function getInstituicaoIdByNome(nome: string): number | null {
    const instituicao = instituicoes.find((m) => m.nome === nome);
    return instituicao ? instituicao._id : null;
  }
*/
                    ...
                    {instituicoesSelecionadas.includes(inst._id) &&
                      instituicoesEspecificas
                        ...
                        .map((esp) => (
                          <button
                            key={esp._id}
                            onClick={() => toggleInstituicaoEspecifica(esp._id)}
        ...
        {instituicoesEspecificasSelecionadas.length > 0 && (
          <div className="flex items-center gap-2 flex-wrap">
            ...
            {instituicoesEspecificasSelecionadas.map((id) => {
              const instEsp = instituicoesEspecificas.find((i) => i._id === id);
